...
getHomeR = defaultLayout $ do
           ...
           [whamlet|
               ...
               <ul>
                  <li> <a href=@{PecaR}> Cadastro de peca
                  <li> <a href=@{FornR}> Cadastro de fornecedor
                  <li> <a href=@{OrdemR}> Cadastro de ordem
                  <li> <a href=@{ListarPecaR}> Listagem de peca
                  <li> <a href=@{ListarFornR}> Listagem de fornecedor
                  <li> <a href=@{ListarOrdemR}> Listagem de ordem
